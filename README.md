...
- Comparative **CSF physiology and turnover** across rodent, nonhuman primate, and human (CSF volume, formation/absorption rate) from the CSF-dynamics literature. [7](https://www.tandfonline.com/doi/full/10.1517/17425247.2016.1171315); [8](https://pmc.ncbi.nlm.nih.gov/articles/PMC10409822/); [9](https://aalas.kglmeridian.com/view/journals/72010023/70/6/article-p526.xml)
- Literature on **route of CSF administration** (intra-cisterna-magna vs lumbar vs intracerebroventricular) and its effect on CNS vector distribution. [10](https://www.sciencedirect.com/science/article/pii/S2329050120300619); [11](https://www.frontiersin.org/journals/neuroanatomy/articles/10.3389/fnana.2014.00042/full); [12](https://pubmed.ncbi.nlm.nih.gov/30032644/).
- **DRG detargeting** of AAV transgene expression via incorporation of ganglion-enriched **miR-183 target sites**, as a capsid/cassette engineering approach to the sensory-neuron toxicity. [13](https://pubmed.ncbi.nlm.nih.gov/33177182/)
- The **secreted-enzyme / cross-correction** paradigm for CNS lysosomal storage disorders (enzyme uptake by bystander cells via mannose-6-phosphate receptor), as the mechanistic basis of the PD model. [14](https://www.cell.com/molecular-therapy-family/molecular-therapy/fulltext/S1525-0016(06)00022-0?_returnURL=https%3A%2F%2Flinkinghub.elsevier.com%2Fretrieve%2Fpii%2FS1525001606000220%3Fshowall%3Dtrue); [15](https://www.nature.com/articles/nrm1050)
- **Bayesian / population-PK model updating** and credible-interval reporting for dose justification under sparse preclinical data; **visual predictive checks** (incl. prediction-corrected VPC) for model evaluation. [16](https://link.springer.com/article/10.1208/s12248-011-9255-z); [17](https://arxiv.org/abs/1804.06788); [18](https://www.sciencedirect.com/science/article/abs/pii/S0010465509003087?via%3Dihub); [19](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/assessing-credibility-computational-modeling-and-simulation-medical-device-submissions)
